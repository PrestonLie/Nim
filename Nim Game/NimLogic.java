...
public class NimLogic {
    ...
    public void run() {
        ...
        while (playAgain == 1) {
            ...
            System.out.println("The player, " + activePlayer.getName() + " has won the round of nim. " + player1.getName() + " has " + player1.getPoints() + " and " + player2.getName() + " has " + player2.getPoints() + " has ");
